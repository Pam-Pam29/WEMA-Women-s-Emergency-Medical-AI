...
SYSTEM = (
    ...
    "- bleeding from a cut or tear after birth (bleeding from a wound, not from inside the womb) -> apply firm pressure with the cleanest cloth available, do not remove it once applied, add more cloth on top if needed, do NOT massage the belly, get to facility immediately;\n"
    "- gestational diabetes high blood sugar with confusion, dizziness, or has not eaten -> sit down, eat something small right now, get to facility if confusion worsens;\n"
    ...
    "NEVER mention a symptom she did not describe — for example, do not say she is bleeding unless bleeding was mentioned.\n"
